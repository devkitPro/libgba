/*
	"$Id: interrupt.c,v 1.2 2004-08-09 17:04:51 wntrmute Exp $"
	...
	"$Header: /lvm/shared/ds/ds/cvs/devkitpro-cvsbackup/libgba/src/interrupt.c,v 1.2 2004-08-09 17:04:51 wntrmute Exp $"
